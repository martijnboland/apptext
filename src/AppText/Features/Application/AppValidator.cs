...
namespace AppText.Features.Application
{
    public class AppValidator : Validator<App>
    {
        protected override Task ValidateCustom(App app)  
        {
            ...
            {
                AddError(new ValidationError { Name = "Languages", ErrorMessage = "AppText:DefaultLanguageNotInLanguages", Parameters = new object[] { app.Languages, app.DefaultLanguage } } );
            }
